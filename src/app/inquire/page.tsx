...
import {MdOutlineHandshake, MdOutlineSecurity} from "react-icons/md";
import {HiLightBulb} from "react-icons/hi";
import {ContactForm} from "@/components/ContactForm";

export default function InquirePage () {
    return (
        <div className="px-12 lg:px-20 xl:px-32 py-10">
            <div className="flex flex-col w-full items-center justify-center">
                <h1 className="text-5xl text-branding-blue-500 font-bold">Let's Collaborate!</h1>
                <p className="text-sm text-black font-bold w-full md:w-1/2 text-center leading-[25px] mt-4">At The House Of Code, collaboration is at the heart of everything we do. By working together, we can unlock the full potential of your organization and craft exceptional digital experiences that leave a lasting impact</p>
            </div>
            ...
            <div className="flex flex-col w-full items-center justify-center my-4">
                <h1 className="text-2xl text-branding-blue-500 font-bold">Let's Get Started!</h1>
                <p className="text-sm md:text-lg text-black font-bold w-full md:w-1/2 text-center leading-[25px] mt-4">
